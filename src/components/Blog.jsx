      ...
      <div ref={ref}>
        ...
        <div className="border border-slate-200 rounded-md p-4 mb-8 md:mb-12">
          ...
          <p className="px-8">
            ...
            <br /> <br />
            We can use React props, to send data from one component to another. If
            a component receives the wrong type of props, it can cause bugs and
            unexpected errors in your app.
            <br />
            In this context, we can use “PropTypes” for props validation in react.
            <br /> <br /> <br />
            PropTypes is Reacts internal mechanism for adding type checking to
            ...
            the type definitions configured in the propTypes property.
            <br /> <br />
            However, to get access to the PropTypes utility, we need to add
            prop-types as a dependency for your project. Command to install: npm
            install prop-types --save & to import: import PropTypes from
            prop-types;
          </p>
        </div>
        ...
        <div className="border border-slate-200 rounded-md p-4 mb-8 md:mb-12">
          ...
          <p className="px-8">
            Node.js is an open source and cross-platform built on Chromes
            JavaScript runtime for easily building fast, scalable network
            applications & it allows executing JavaScript code outside of a
            browser.
            <br />
            You need to keep in mind that NodeJS is not a framework and it is not
            a programming language.
            <br /> <br />
            On the contrary, Express is a minimal and flexible node.js web
            application framework that sits on top of Node.js web server
            functionality to simplify its APIs and add helpful new features.
            <br />
            It makes it easier to organize your application functionality with
            middle ware and routing.
            <br />
            It adds helpful utilities to Node.js HTTP objects. It facilitates the
            ...
            <b>1.</b>
            <br /> <br />
            Express.js is used to build web-apps using approaches and principles
            of Node.js. It is a framework built on Node.js.
            <br /> <br />
            Node,js is used to build server-side, input-output, event-driven apps.
            It is built on Googles V8 engine. It is not a framework, rather it is
            a run-time platform or environment designed for server-side execution
            of JavaScript.
            <br /> <br />
            <b>2.</b>
            <br /> <br />
            It offers more features than Node.js. Such as: controllers, routing
            are provided here. It can also use middleware for the arrangement of
            functions systematically server-side.
            <br /> <br />
            It offers fewer features. Here, controllers & routing are not
            provided. It does not allow to use middleware provision.
            <br /> <br />
            <b>3.</b>
            <br /> <br />
            Besides these, express.js is written in JavaScript. So, it requires
            less coding time.
            <br /> <br />
            On the other hand, node.js is written in C, C++ & JavaScript. So, it
            requires more coding time.
          </p>
        </div>
        ...
        <div className="border border-slate-200 rounded-md p-4 mb-8 md:mb-12">
          ...
          <p className="px-8">
            Custom Hook is a special functionality of React router. Besides using
            react custom hook, we can create our own hook function such as custom
            loader and many more & use it very easily.
            <br /> <br />
            Generally, custom hooks functions might be created to hold or save the
            custom hook or custom loader function.
            <br /> <br />
            In React, a custom Hook is{" "}
            <b>
              a function that starts with the word “use” and may call other Hooks.
            </b>
            <br /> <br />
            So, If necessary we can create a custom function like raw loader of
            jsx and use it instead of loader. In this case, different loader
            functions including cartProductsLoader, js can be written in a
            separate folder called loaders in components folder or src.
          </p>
        </div>
      </div>
    </div>
